const { createUserRef, updateUserRef, deleteUserRef, getCurrentUserRef, listUsersRef, createProjectRef, updateProjectRef, deleteProjectRef, getProjectRef, listProjectsRef, createTaskRef, updateTaskRef, deleteTaskRef, getTaskRef, listTasksRef, createCommentRef, updateCommentRef, deleteCommentRef, getCommentRef, listCommentsRef, createTeamMemberRef, updateTeamMemberRef, deleteTeamMemberRef, getTeamMemberRef, listTeamMembersRef, connectorConfig } = require('../index.cjs.js');
...
exports.useGetTeamMember = function useGetTeamMember(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
  const ref = getTeamMemberRef(dcInstance, inputVars);
  return useDataConnectQuery(ref, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}

exports.useListTeamMembers = function useListTeamMembers(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
  const ref = listTeamMembersRef(dcInstance, inputVars);
  return useDataConnectQuery(ref, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}